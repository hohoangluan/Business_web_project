...
from performance.services.evaluation_data import get_demo_display_name
...
def build_rewards_penalties_records(users):
    ...
    for index, user in enumerate(users):
        ...
        proposer = work_info.leader_user or work_info.manager_user
        proposer_name = get_demo_display_name(proposer) if proposer else 'HR'
        proposer_role = 'Leader' if work_info.leader_user else 'Manager' if work_info.manager_user else 'HR'
